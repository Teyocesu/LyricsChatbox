...
| 7 Release gate | PASSED / PUBLICATION NEXT | Release build 0 warnings/errors, full suite 61 passed; reviewed diff/licenses/package and critical physical checks complete |
