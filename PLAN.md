...
Product owner physically compares Phase 2.2 About in wide and compact layouts with the canonical reference and accepts or requests corrections. Do not start Phase 3 or implement the deferred v0.8.1 scope before that review is complete.
